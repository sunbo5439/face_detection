...
def train_24net(X_train_1,X_train_2, y_train):
    ...
    open('../model/24net_architecture.json', 'w').write(json_string)
    model.save_weights('../model/24net_weights.h5')

def get_24net():
    model = model_from_json(open('../model/24net_architecture.json').read())
    model.load_weights('../model/24net_weights.h5')
    return model